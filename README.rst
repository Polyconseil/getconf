...
``getconf`` v1.10 onwards supports Python 3.5, 3.6 and 3.7 and is distributed under the two-clause BSD license.
v1.9.x are the last versions to support 2.7 and 3.4.
